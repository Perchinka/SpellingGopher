#!/usr/bin/env bash
# Cut a release: bump the version, tag it, and push so the Release workflow
# (.github/workflows/release.yml) builds and publishes via GoReleaser.
#
...
REPO_SLUG="Perchinka/SpellingGopher"
