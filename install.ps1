# Windows installer for SpellingGopher.
...
# %LOCALAPPDATA%\Programs\spelling-gopher):
#   $Env:InstallDir = "C:\tools\spelling-gopher"; irm .../install.ps1 | iex

$ErrorActionPreference = "Stop"

$Repo = "Perchinka/SpellingGopher"
